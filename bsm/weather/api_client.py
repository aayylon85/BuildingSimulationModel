...
def get_hourly_weather(latitude, longitude, start_date, end_date, timezone="GMT", hourly_variables=None):
    ...
    if hourly_variables is None:
        hourly_variables = [
            "temperature_2m",
            "dew_point_2m",  # For Berdahl-Martin sky temperature model
            "precipitation",
            "rain",
            "snowfall",
            "surface_pressure",
            ...
            "diffuse_radiation_instant",  # DHI for solar calculations
            "direct_normal_irradiance_instant",  # DNI for solar calculations
            "global_tilted_irradiance_instant",
            "terrestrial_radiation_instant",
            "shortwave_radiation_instant",  # GHI
            "cloud_cover",  # For sky temperature calculation
            # Soil temperature at multiple depths for ground temperature calculations
            # More accurate than Kusuda model for short simulations
