...
class Zone:
    ...
    def __init__(self, zone_properties, geometry_data, constructions, dt_seconds,
        ...
        Args:
            ...
            interior_radiation_method: Interior radiation calculation method (default: 'area_weighted')
                - 'area_weighted': Simple area-weighted MRT (fastest)
                - 'carroll': Carroll MRT preserving T^4 nonlinearity (good balance)
                - 'view_factor': Full view factor matrix (most accurate)
        """
        ...
        # Build zone geometry for view factor method (if needed)
        zone_geometry = {
            'length': zone_properties['length'],
            'width': zone_properties['width'],
            'height': zone_properties['height']
        }
        ...
        self.solver = ZoneHeatBalanceSolver(
            ...
            interior_radiation_method=interior_radiation_method,
